...
/* Workbench design tokens (docs/styles.css) — the applicable subset: Duke palette
 * + wordmark topbar + card/button/field, so this panel matches the drive dashboard. */
":root{color-scheme:dark;--duke-navy:#012169;--duke-royal-blue:#00539B;--duke-light-blue:#0577B1;"
"--bg:#1a1d20;--surface:#212529;--ink:#e9ecef;--ink-muted:#adb5bd;--border:rgba(255,255,255,.10);"
"--accent:var(--duke-royal-blue);--accent-ink:#fff;--brand:var(--duke-light-blue);--radius:8px;--topbar:52px}"
"*{box-sizing:border-box}"
"body{margin:0;background:var(--bg);color:var(--ink);"
"font-family:system-ui,-apple-system,'SF Pro Text','Helvetica Neue',Arial,sans-serif;font-size:15px;"
"line-height:1.5;-webkit-font-smoothing:antialiased}"
".topbar{display:flex;align-items:center;height:var(--topbar);padding:0 20px;"
"border-bottom:1px solid var(--border)}"
".topbar h1{font-size:17px;letter-spacing:-.01em;margin:0}"
".topbar .a{font-weight:700;color:var(--brand)}"
".topbar .b{font-weight:400;color:color-mix(in srgb,var(--ink) 75%,transparent)}"
"main{max-width:32rem;margin:0 auto;padding:24px 16px 48px}"
".card{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);"
"padding:20px;margin-bottom:16px}"
".card>h2{font-size:18px;font-weight:600;letter-spacing:-.01em;color:var(--brand);margin:0 0 6px}"
...
"border-radius:8px;border:1px solid var(--border);background:var(--bg);color:var(--ink)}"
"button{background:var(--accent);color:var(--accent-ink);border:0;font-weight:500;cursor:pointer;"
"min-height:44px;transition:filter .15s}button:hover{filter:brightness(1.08)}button:active{filter:brightness(.94)}"
"input:focus,select:focus{outline:none;border-color:var(--duke-light-blue)}"
"#nets button{background:var(--bg);border:1px solid var(--border);color:var(--ink);text-align:left;"
"display:flex;justify-content:space-between;min-height:0}"
